...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>On-Road Vehicle Breakdown Assistant || Home Page </title>
        ...
        <div class="slider-area">
            <div class="bend niceties preview-1">
                ...
                <div id="nivoslider" class="slides">
                    <img src="img1/slider/towing3.jpg" alt="slider_1" title="#slider-direction-1"/>
                    <img src="img1/slider/towing2.jpg" alt="slider_2" title="#slider-direction-2"/>
                    <img src="img1/slider/towing4.jpg" alt="slider_3" title="#slider-direction-3"/>
                    <img src="img1/slider/towing5.jpg" alt="slider_4" title="#slider-direction-4"/>
                    <img src="img1/slider/towing6.jpg" alt="slider_5" title="#slider-direction-5"/>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9">
                                    <!-- layer 1 -->
                                    <div class="layer-1-1">
                                        <h2 class="title-1">On-Road </h2>
                                    </div>
                                    <!-- layer 2 -->
                                    <div class="layer-1-2">
                                        <h2 class="title-2"> Vehicle Breakdown Assistant </h2>
                                    </div>
                                    <!-- layer 3 -->
                                    <div class="layer-1-3">
                                        <p class="title-3"> Tushal Dhumale(CEO) </p>
                                    </div>
                                    <!-- layer 4 -->
                                    <div class="layer-1-4">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                  ...
                                  <div class="layer-1-1">
                                    ...
                                    <!-- layer 3 -->
                                    <div class="layer-2-3">
                                        <p class="title-3"> Trushal Dhumale(CEO) </p>
                                    </div>
                                    <!-- layer 4 -->
                                    <div class="layer-2-4">
                                        <a href="contact.php" class="title-4">contact us </a>
