...
<head>
    ...
    <title>Vehicle Break Down Assistance Management System: Manage Mechanic</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Mange Mechanic</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Mange</strong> Mechanic </h2>
                            </div>
                            <div class="body">
